...
pub type ChildListIter<'a> = search_graph::ParentListIter<'a, game::State, NodeData, EdgeData>;
pub type ParentList<'a> = search_graph::ParentList<'a, game::State, NodeData, EdgeData>;
pub type ParentListIter<'a> = search_graph::ParentListIter<'a, game::State, NodeData, EdgeData>;
