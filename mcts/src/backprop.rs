...
use super::{EdgeData, Game, SearchSettings, ThreadId, VertexData};
...
pub trait BackpropSelector<'a, G, R>: From<SearchSettings>
where
  G: 'a + Game,
  R: Rng,
{
...
pub fn backprop<'a, G, S, R>(
  ...
  <S as BackpropSelector<'a, G, R>>::Error,
>
where
  G: Game,
